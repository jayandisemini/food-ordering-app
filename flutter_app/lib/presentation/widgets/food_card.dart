      ...
      child: InkWell(
        ...
        children: [
          ...
          Row(children: [
            ...
            Text('${food.rating}', style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700)),
            const SizedBox(width: 8),
            const Icon(Icons.access_time, size: 12, color: Colors.white54),
            const SizedBox(width: 2),
            Expanded(child: Text(food.time, style: const TextStyle(fontSize: 11, color: Colors.white54), overflow: TextOverflow.ellipsis)),
          ]),
